...
import { g, ff, JOIN_STEP1_NEW, JOIN_STEP2_NEW, JOIN_STEP3_NEW, SCRIPT } from '../constants/index.js';
...
export function JoinC({ onDone }) {
  ...
  const st = [
    { e: JOIN_STEP1_NEW, t: t('joinC.step1.t'), d: t('joinC.step1.d') },
    { e: JOIN_STEP2_NEW, t: t('joinC.step2.t'), d: "\"" + SCRIPT + "\"" },
    { e: JOIN_STEP3_NEW, t: t('joinC.step3.t'), d: t('joinC.step3.d') },
  ];
